...
public class SemanticInterface {
    ...
    public SemanticInterface() {
        if (snet == null) {
            ...
            /*Carrega el properties amb l'adre�a de l'XML de configuraci� del SemanticNet
    ...
    /**
     * Retrona el node amb 'idNode' com a id. i del t�pus 'sNType'.
     *
     * @param idNode Identificador del node.
     * @param sNType T�pus del node.
     * @return
     */
     ...
     *
     * @param idNode Identificador del node amb qu� han d'estar relacionats.
     * @return Llista de {infonode} on els infonode contenen la informaci�
    ...
    public ArrayList getLevels(int idNode) {
        ...
        try {
            ...
            if (n.getProperties() != null && n.getProperties().containsKey("relatedLevel")) {
                ...
                //El node passat �s el 0. Punt d'origen.
                if (((ArrayList) h.get("list")).isEmpty()) {
                    h = new Hashtable();
                    h.put("term", "Clica aqu� per afegir un node Level.");
                    h.put("idNode", new Integer(-1));
     ...
     * 'idLevel' donat.
     *
     * @param idArea Identificador del node "area" amb qu� han d'estar
     * relacionats.
     * @param idLevel Identificador del node "level" amb qu� han d'estar
     * relacionats.
     * @return Llista de {infonode} on els 'infonode' contenen la informaci�
     * necessaria d'un node.
     */
    public ArrayList getArees(int idArea, int idLevel) {
        ...
        al.clear();
        h = new Hashtable();
        h.put("term", "Clica aqu� per afegir un node Area.");
        h.put("idNode", new Integer(-1));
        h.put("nodeType", "area");
        h.put("description", "Clica aqu� per agfegir un nou node al sistema.");
    ...
    /**
     * Retorna tots els nodes del t�pus "content" relacionats amb els nodes
     * donats.
     *
     * @param idContent Identificador del node "content" amb qu� han d'estar
     * relacionats.
     * @param idLevel Identificador del node "area" amb qu� han d'estar
     * relacionats.
     * @param idArea Identificador del node "level" amb qu� han d'estar
     * relacionats.
     * @return Llista de {infonode} on els 'infonode' contenen la informaci�
     * necessaria d'un node.
     */
    public Hashtable getContents(int idContent, int idLevel, int idArea) {
        ...
        if (((ArrayList) hRes.get("cp")).isEmpty()) {
            h = new Hashtable();
            h.put("term", "Clica aqu� per afegir un node Contingut.");
            h.put("idNode", new Integer(-1));
            h.put("nodeType", "content");
            h.put("category", "cp");
            h.put("description", "Clica aqu� per agfegir un nou node al sistema.");
    ...
    /**
     * Retorna tots els nodes del t�pus "objective" relacionats amb els nodes
     * donats.
     *
     * @param idLevel Identificador del node "area" amb qu� han d'estar
     * relacionats.
    ...
    public Hashtable getObjectives(int idLevel, int idArea) {
        ...
        if (((ArrayList) hRes.get("op")).isEmpty()) {
            h = new Hashtable();
            h.put("term", "Clica aqu� per afegir un node Objectiu.");
            h.put("idNode", new Integer(-1));
     ...
     * @param nodeType T�pus del node donat.
     * @return Llista de {infonode} on els 'infonode' contenen la informaci�
     * necessaria d'un node.
     */
     ...
     * del node germ� situat en la posici� anterior o posterior, depenent del
     * valor de 'amunt'.
     *
     * @param idNode Identificador del node que es vol canviar de posici�.
     * @param idLevel Identificador del node "level" relacionat amb aquest. �til
     * en cas de ser del t�pus "content" o "objective.
     * @param idArea Identificador del node "area" relacionat amb aquest. �til
     * en cas de ser del t�pus "content" o "objective.
     * @param nodeType T�pus del node 'idNode'
     * @param amunt TRUE si es vol canviar la posici� amb el germ� superior,
     * altrament FALSE.
     * @throws DUCException
     */
     ...
     *
     * @param dtoNode Hashtable amb tota la informaci� necessaria del node.
     * @throws DUCException
     */
...
//			}
            ...
            //Reordena tots els nodes germans i li dona la nova posici� al nou node.
            int aux = 0;
            ...
            if (((Hashtable) dtoNode.get("properties")).containsKey("thesaurusKeys")) {
                ...
                for (int j = 0; j < thes.size(); j++) {
                    //Recupera el seg�ent valor d'identificador per insertar a la taula cur_thesaurus.
     ...
     * 'nodeType' hi s�n obligatoris.
     *
     * @param dtonode Hashtable amb la informaci� dels camps que es volen
     * modificar.
     * @throws DUCException
     */
    public void setNode(Hashtable dtonode) throws DUCException {
        try {
            ...
            if (((Hashtable) dtonode.get("properties")).containsKey("thesaurusKeys")) {
                ...
                for (int j = 0; j < thes.size(); j++) {
                    //Recupera el seg�ent valor d'identificador per insertar a la taula notes.
    ...
    /**
     * Elimina del sistema el node 'idNode' del t�pus 'sNType'.
     *
     * @param idNode Identificador del node que es vol eliminar.
     * @param sNType T�pus del node 'idNode'.
     */
...
//				}
    ...
    public ArrayList getRadioCollection(String id) {
        ...
        if (id.compareTo("nodeType") == 0) {
            ...
            al.add(lvb);
            lvb = new LabelValueBean("�rea", "area");
            al.add(lvb);
