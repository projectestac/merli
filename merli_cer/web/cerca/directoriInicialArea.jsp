                            ...
                            <%
                                ...
                                while (i < allAreasLevel.size()) {
                                    ...
                                    if (!ducObject.term.startsWith("Compet�ncies")) {
                                        String urlArea = "https://" + Configuracio.servidorWeb + "/" + Configuracio.contextWebAplicacio + "/ServletCerca?tipus=completa&nivell=0&ordenacio=&novaCerca=si&textCerca=&nivell_educatiu=" + idLevelInt + "&area_curricular=" + ducObject.id + "&cataleg=si";
                            %>
                    ...
                    <div id="taula">
                        ...
                        <%     }
                            ...
                            while (i < recursosMesBenValorats.size()) {
                                ...
                                String urlRecurs = "https://" + Configuracio.servidorWeb + "/" + Configuracio.contextWebAplicacio + "/cerca/fitxaRecurs.jsp?idRecurs=" + recursObject.id;
                        ...
                        <div id="taula">
                            ...
                            <%     }
                                ...
                                while (i < recursosMesVisitats.size()) {
                                    ...
                                    String urlRecurs = "https://" + Configuracio.servidorWeb + "/" + Configuracio.contextWebAplicacio + "/cerca/fitxaRecurs.jsp?idRecurs=" + id;
